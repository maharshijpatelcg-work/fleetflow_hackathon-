        ...
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 transition-all">
            <div className="flex items-center gap-4 mb-8">
                <div className={`p-3 rounded-xl ${editingVehicle ? 'bg-amber-100 text-amber-700' : 'bg-blue-100 text-blue-700'}`}>
                    {editingVehicle ? (
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><line x1="12" x2="12" y1="5" y2="19" /><line x1="5" x2="19" y1="12" y2="12" /></svg>
                    )}
                </div>
            ...
            {error && (
                <div className="mb-6 p-4 bg-red-50 text-red-700 text-base font-medium rounded-xl border border-red-100 flex items-start gap-3 animate-pulse transition-opacity">
                    <svg xmlns="http://www.w3.org/2000/svg" className="mt-0.5 shrink-0" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /><line x1="12" x2="12" y1="8" y2="12" /><line x1="12" x2="12.01" y1="16" y2="16" /></svg>
                    <span>{error}</span>
                </div>
            )}
